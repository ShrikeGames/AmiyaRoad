...
; (function (name, context, factory) {
  ...
  Cover.prototype.encode = function (message, imageId, options) {
    ...
    shadowCanvas.height = options.height;
    console.log(shadowCanvas.width, shadowCanvas.height);
    shadowCtx = shadowCanvas.getContext('2d');

    shadowCtx.drawImage(image, options.dx, options.dy, shadowCanvas.width, shadowCanvas.height, 0, 0, shadowCanvas.width, shadowCanvas.height);
